...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2023/1/21");
    setInterval(function () {
        ...
        $('.time').html("<p>2023学测倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>没想到2023学测马上就要到了</span><span class='B-span2'>学测加油！</span><span>祝我考个好大学</span>";
    $(".Barrage").append(mess);
